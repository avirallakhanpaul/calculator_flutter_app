    ...
    return Consumer<ThemeProvider>(builder: (ctx, theme, _) {
      return GridView.builder(
        ...
        itemBuilder: (ctx, index) {
          btnTextColor =
              theme.isDarkTheme ? darkSecondaryGrey : lightSecondaryBlack;
          ...
          if (index == 0) {
            ...
            // =
            return Button(
              btnColor: theme.isDarkTheme ? darkPrimaryBlue : lightPrimaryBlue,
              btnText: buttons[index],
              btnTextColor: Colors.white,
              isEqualButton: true,
              isTapped: () =>
                  calcProvider.evaluateResult(calcProvider.question),
            );
            ...
            if (buttons[index] == "/") {
              return Button(
                ...
                // ),
                btnTextColor:
                  theme.isDarkTheme ? darkPrimaryBlue : lightPrimaryBlue,
                isTapped: () => calcProvider.appendQuestion(buttons[index]),
              );
            } else {
              return Button(
